	...
	float YawOverride)
{
	...
	for (USceneComponent* Pt : ImmutablePts)
	{
		...
		if (Pt != Pt_0)
		{
			// Rotating a point based on the YawOverride Relative to PT_0
		...
		// we are using this GetLivePlayersWithInRadius to Fill up ActorsToIgnore to use it as ActorsToIgnore for A lineTrace
		UAuraAbilitySystemLibrary::GetLivePlayersWithInRadius(this,ActorsToIgnore,TArray<AActor*>(),1500.f,GetActorLocation());
